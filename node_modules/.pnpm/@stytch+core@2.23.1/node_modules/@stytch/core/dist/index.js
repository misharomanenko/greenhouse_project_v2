    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 9:
          ...
          throw new ui.StytchAPIUnreachableError('Unable to contact the Stytch servers. Are you online?');
        case 13:
          throw _context2.t0;
        case 14:
          if (!(resp.status <= 299)) {
        ...
        case 22:
          ...
          throw new ui.StytchAPIUnreachableError('Invalid JSON response from the Stytch servers.');
        case 25:
        ...
        case 44:
          ...
          throw new ui.StytchAPIUnreachableError('Invalid response from the Stytch servers.');
        case 47:
          ...
          while (1) switch (_context22.prev = _context22.next) {
            ...
            case 8:
              ...
              if (!!(options === null || options === void 0 ? void 0 : options.forceClear)) {
                this._subscriptionService.destroyState();
              } else if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context22.t0.error_type)) {
                this._subscriptionService.destroyState();
              }
              throw _context22.t0;
            case 12:
        ...
        return _regeneratorRuntime().wrap(function _callee23$(_context23) {
          while (1) switch (_context23.prev = _context23.next) {
            ...
            case 6:
              ...
              return _context23.abrupt("return", this.authenticate(options));
            case 9:
            ...
            case 13:
              ...
              return _context23.abrupt("return", this.authenticate(options));
            case 17:
              if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context23.t0.error_type)) {
  ...
  function HeadlessMagicLinksClient(_networkClient, _subscriptionService, _pkceManager, _passwordResetPKCEManager) {
    ...
    this.email = {
      loginOrCreate: function loginOrCreate(email) {
        ...
        return __awaiter(_this6, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee24() {
...
var HeadlessOTPClient = /*#__PURE__*/_createClass(function HeadlessOTPClient(_networkClient, _subscriptionService) {
  ...
  this.sms = {
    loginOrCreate: function loginOrCreate(phone_number, options) {
      return __awaiter(_this7, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee29() {
  ...
  _createClass(HeadlessOAuthClient, [{
    ...
    value: function startOAuthFlow(providerType) {
      ...
      return function () {
        ...
        return __awaiter(_this8, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee38() {
        ...
        return _regeneratorRuntime().wrap(function _callee39$(_context39) {
          while (1) switch (_context39.prev = _context39.next) {
            ...
            case 8:
              ...
              return _context39.abrupt("return", this._apiNetworkClient.fetchSDK({
                url: endpoint,
                method: 'POST',
        ...
        return _regeneratorRuntime().wrap(function _callee51$(_context51) {
          while (1) switch (_context51.prev = _context51.next) {
            case 0:
              ...
              return this._config;
            case 2:
              _yield$this$_config4 = _context51.sent;
  ...
  function HeadlessB2BMagicLinksClient(_networkClient, _subscriptionService, _pkceManager, _passwordResetPKCEManager) {
    ...
    this.email = {
      invite: function invite(data) {
        return __awaiter(_this9, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee59() {
...
var HeadlessB2BOrganizationClient = /*#__PURE__*/_createClass(function HeadlessB2BOrganizationClient(_networkClient, _apiNetworkClient, _subscriptionService) {
  ...
  this._subscriptionService = _subscriptionService;
  this.get = function () {
    return __awaiter(_this12, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee91() {
      var resp;
  ...
  this.update = function (data) {
    return __awaiter(_this12, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee92() {
      var resp;
  ...
  this["delete"] = function () {
    return __awaiter(_this12, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee93() {
      var resp;
  ...
  _createClass(HeadlessB2BOAuthClient, [{
    ...
    value: function startOAuthFlow(providerType) {
      ...
      return function (_ref5) {
        ...
        return __awaiter(_this14, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee107() {
    ...
    value: function startDiscoveryOAuthFlow(providerType) {
      ...
      return function (_ref6) {
        ...
        return __awaiter(_this15, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee108() {
...
var HeadlessB2BSessionClient = /*#__PURE__*/function () {
  function HeadlessB2BSessionClient(_networkClient, _subscriptionService) {
    ...
    this.revoke = function (options) {
      return __awaiter(_this16, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee109() {
        var resp;
        return _regeneratorRuntime().wrap(function _callee109$(_context109) {
          while (1) switch (_context109.prev = _context109.next) {
            ...
            case 8:
              ...
              if (!!(options === null || options === void 0 ? void 0 : options.forceClear)) {
                this._subscriptionService.destroyState();
              } else if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context109.t0.error_type)) {
                this._subscriptionService.destroyState();
              }
    ...
    this.revokeForMember = function (options) {
      return __awaiter(_this16, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee110() {
    ...
    this.authenticate = function (options) {
      return __awaiter(_this16, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee111() {
        var _this17 = this;
        var initialSession, isSessionStale, requestBody, resp;
        return _regeneratorRuntime().wrap(function _callee111$(_context111) {
          while (1) switch (_context111.prev = _context111.next) {
            ...
            case 13:
              ...
              return _context111.abrupt("return", this.authenticate(options));
            case 17:
              if (ui.UNRECOVERABLE_ERROR_TYPES.includes(_context111.t0.error_type)) {
                this._subscriptionService.destroySession();
              }
...
var HeadlessB2BDiscoveryClient = /*#__PURE__*/_createClass(function HeadlessB2BDiscoveryClient(_networkClient, _subscriptionService) {
  ...
  this.organizations = {
    list: function list() {
      return __awaiter(_this18, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee113() {
    ...
    create: function create(data) {
      return __awaiter(_this18, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee114() {
  ...
  this.intermediateSessions = {
    exchange: function exchange(data) {
      return __awaiter(_this18, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee115() {
        var requestBody, resp;
...
var HeadlessB2BPasswordsClient = /*#__PURE__*/function () {
  ...
  _createClass(HeadlessB2BPasswordsClient, [{
    key: "getCodeChallenge",
    value: function getCodeChallenge() {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee116() {
    ...
    key: "authenticate",
    value: function authenticate(options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee117() {
    ...
    key: "resetByEmailStart",
    value: function resetByEmailStart(options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee118() {
    ...
    key: "resetByEmail",
    value: function resetByEmail(options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee119() {
    ...
    key: "resetByExistingPassword",
    value: function resetByExistingPassword(options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee120() {
    ...
    key: "resetBySession",
    value: function resetBySession(options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee121() {
...
var HeadlessB2BOTPsClient = /*#__PURE__*/_createClass(function HeadlessB2BOTPsClient(_networkClient, _subscriptionService, dfpProtectedAuth) {
  ...
  this.sms = {
    send: function send(data) {
      return __awaiter(_this19, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee123() {
    ...
    authenticate: function authenticate(data) {
      return __awaiter(_this19, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee124() {
      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee131() {
        ...
        return _regeneratorRuntime().wrap(function _callee131$(_context131) {
          while (1) switch (_context131.prev = _context131.next) {
            ...
            case 12:
              _context131.prev = 12;
              _context131.t0 = _context131["catch"](5);
              port.postMessage({
                success: false,
                error: ErrorMarshaller.marshall(_context131.t0)
              });
            case 15:
            case "end":
              return _context131.stop();
          }
        }, _callee131, this, [[5, 12]]);
      }));
    }
...
var SessionManager = /*#__PURE__*/function () {
  function SessionManager(_subscriptionService, _headlessSessionClient) {
    ...
    this._reauthenticateWithBackoff = function () {
      return __awaiter(_this25, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee132() {
        var count;
...
var SubscriptionDataLayer = /*#__PURE__*/function () {
  function SubscriptionDataLayer(_publicToken, _storageClient) {
    ...
    this.syncFromLocalStorage = function () {
      return __awaiter(_this29, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee133() {
        var _this30 = this;
        return _regeneratorRuntime().wrap(function _callee133$(_context133) {
          while (1) switch (_context133.prev = _context133.next) {
            case 0:
              return _context133.abrupt("return", this._storageClient.getData(getLocalStorageKey(this._publicToken)).then(function (localData) {
                if (!localData) {
                  return null;
                }
                var parsedState;
    ...
    value: function syncFromDeviceStorage(onCompleteCallback) {
      ...
      this._datalayer.syncFromLocalStorage().then(function (res) {
        ...
        if (!res) {
          ...
          _this31.updateStateAndTokens(res, shouldTryRefresh(res.state));
        }
      })["finally"](function () {
        onCompleteCallback();
      });
...
var ConsumerSubscriptionService = /*#__PURE__*/function (_SubscriptionService) {
  ...
  function ConsumerSubscriptionService() {
    ...
    _this32 = _callSuper(this, ConsumerSubscriptionService, arguments);
...
var B2BSubscriptionService = /*#__PURE__*/function (_SubscriptionService2) {
  ...
  function B2BSubscriptionService() {
    ...
    _this33 = _callSuper(this, B2BSubscriptionService, arguments);
    ...
    _this33.updateOrganization = function (organization) {
      return _this33.updateState({
        organization: organization
      });
    };
    _this33.getOrganization = function () {
      var _a, _b;
      return (_b = (_a = _this33.getState()) === null || _a === void 0 ? void 0 : _a.organization) !== null && _b !== void 0 ? _b : null;
    };
