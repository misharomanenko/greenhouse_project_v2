...
function isPointInPath$8(displayObject, position, isClipPath) {
    ...
    var _g = tslib.__read(gLite.isFillOrStrokeAffected(pointerEvents, fill, stroke), 2), hasFill = _g[0], hasStroke = _g[1];
...
function isPointInPath$6(displayObject, position, isClipPath) {
    ...
    var _e = tslib.__read(gLite.isFillOrStrokeAffected(pointerEvents, fill, stroke), 2), hasStroke = _e[1];
...
function isPointInPath$5(displayObject, position, isClipPath, isPointInPath, renderingPluginContext, runtime) {
    ...
    var _e = tslib.__read(gLite.isFillOrStrokeAffected(pointerEvents, 
...
function isPointInPath$4(displayObject, position, isClipPath) {
    ...
    var _e = tslib.__read(gLite.isFillOrStrokeAffected(pointerEvents, fill, stroke), 2), hasFill = _e[0], hasStroke = _e[1];
    var isHit = false;
...
function isPointInPath$1(displayObject, position, isClipPath, isPointInPath, renderingPluginContext, runtime) {
    ...
    if (pointerEvents === 'non-transparent-pixel') {
        ...
        renderingPluginContext.defaultStyleRendererFactory[gLite.Shape.IMAGE].render(context, tslib.__assign(tslib.__assign({}, displayObject.parsedStyle), { x: 0, y: 0 }), displayObject, undefined, undefined, undefined);
...
function isPointInPath(displayObject, position, isClipPath, isPointInPath) {
    ...
    return (position.x >= bounds.min[0] &&
...
var Plugin = /** @class */ (function (_super) {
    ...
    Plugin.prototype.init = function () {
        ...
        var pointInPathPickerFactory = (_a = {},
            _a[gLite.Shape.CIRCLE] = isPointInPath$8,
            _a[gLite.Shape.ELLIPSE] = isPointInPath$7,
            _a[gLite.Shape.RECT] = isPointInPath$2,
            _a[gLite.Shape.LINE] = isPointInPath$6,
            _a[gLite.Shape.POLYLINE] = isPointInPath$3,
            _a[gLite.Shape.POLYGON] = isPointInPath$4,
            _a[gLite.Shape.PATH] = isPointInPath$5,
            _a[gLite.Shape.TEXT] = isPointInPath,
            _a[gLite.Shape.GROUP] = null,
            _a[gLite.Shape.IMAGE] = isPointInPath$1,
