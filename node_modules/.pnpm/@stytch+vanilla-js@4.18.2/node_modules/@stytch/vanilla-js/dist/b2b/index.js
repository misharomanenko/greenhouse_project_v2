...
var extractErrorMessage = require('../extractErrorMessage-CmRxJsmS.js');
...
var GlobalContextProvider = function GlobalContextProvider(_ref4) {
  ...
  var state = extractErrorMessage.wn.useReducer(reducer$1, initialState !== null && initialState !== void 0 ? initialState : DEFAULT_STATE);
...
var useToaster = function useToaster(toastOptions) {
  ...
  var handlers = extractErrorMessage.F(function () {
    return {
...
var ToastBar = /*#__PURE__*/extractErrorMessage.w(function (_ref2) {
  ...
  var message = /*#__PURE__*/extractErrorMessage.y(Message, Object.assign({}, toast.ariaProps), resolveValue(toast.message, toast));
  return /*#__PURE__*/extractErrorMessage.y(ToastBarBase, {
    className: toast.className,
    style: _extends({}, animationStyle, style, toast.style)
  }, typeof children === 'function' ? children({
    icon: icon,
    message: message
  }) : /*#__PURE__*/extractErrorMessage.y(extractErrorMessage.g, null, icon, message));
});
...
var Toaster = function Toaster(_ref) {
  ...
  return /*#__PURE__*/extractErrorMessage.y("div", {
    style: _extends({
      position: 'fixed',
      zIndex: 9999,
      top: DEFAULT_OFFSET,
    ...
    return /*#__PURE__*/extractErrorMessage.y("div", {
      ...
      key: t.id,
      style: positionStyle
    }, t.type === 'custom' ? resolveValue(t.message, t) : children ? children(t) : /*#__PURE__*/extractErrorMessage.y(ToastBar, {
      toast: t,
...
var Snackbar = function Snackbar() {
  return /*#__PURE__*/extractErrorMessage.wn.createElement(Toaster, {
    containerStyle: {
      position: 'sticky',
      marginTop: '4px',
      marginBottom: '24px'
...
var Flex = extractErrorMessage.He.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: ", ";\n\n  flex-direction: ", ";\n  justify-content: ", ";\n  align-items: ", ";\n  flex-grow: ", ";\n  flex-shrink: ", ";\n  order: ", ";\n  align-self: ", ";\n  flex-flow: ", ";\n  flex-wrap: ", ";\n\n  width: ", ";\n  height: ", ";\n  max-width: ", ";\n  max-height: ", ";\n  min-width: ", ";\n  min-height: ", ";\n  padding: ", ";\n  margin: ", ";\n  margin-top: ", ";\n  margin-right: ", ";\n  margin-bottom: ", ";\n  margin-left: ", ";\n  padding-top: ", ";\n  padding-right: ", ";\n  padding-bottom: ", ";\n  padding-left: ", ";\n\n  gap: ", ";\n"])), function (_ref7) {
...
var Text = extractErrorMessage.He.div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  color: ", ";\n  text-align: ", ";\n  ", ";\n"])), function (props) {
...
var useExtractSlug = function useExtractSlug() {
  ...
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytchClient).bootstrap.getAsync().then(function (_ref37) {
...
var Button = extractErrorMessage.He.button(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  all: unset;\n  width: 100%;\n  height: 45px;\n  border-radius: 4px;\n  cursor: pointer;\n  font-size: 18px;\n  text-transform: none;\n  font-family: ", ";\n  box-shadow: none;\n  text-align: center;\n\n  ", "\n\n  &:disabled {\n    background-color: ", ";\n    color: ", ";\n    border: ", ";\n    border-radius: ", ";\n    cursor: not-allowed;\n  }\n"])), function (props) {
...
var circularDashKeyframe = extractErrorMessage.Ue(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  0% {\n    stroke-dasharray: 1px, 200px;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -15px;\n  }\n  100% {\n    stroke-dasharray: 100px, 200px;\n    stroke-dashoffset: -125px;\n  }\n"])));
var AnimatedCircle = extractErrorMessage.He.circle(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  stroke-dasharray: 80px, 200px;\n  stroke-dashoffset: 0;\n  animation: ", " 1.4s ease-in-out infinite;\n  stroke: ", ";\n  fill: none;\n"])), circularDashKeyframe, function (props) {
  return props.theme.colors.primary;
});
var CircularProgressRoot = extractErrorMessage.He.div(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  width: ", "px;\n  height: ", "px;\n  animation: ", " 1.4s ease-in-out infinite;\n"])), function (props) {
  return props.size;
}, function (props) {
  return props.size;
}, circularRotateKeyframe);
var CircularProgressSVG = extractErrorMessage.He.svg(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  display: block;\n"])));
...
var Input = extractErrorMessage.He.input(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  height: 47px;\n  padding: 0 8px;\n  box-sizing: border-box;\n  border: 1px solid ", ";\n  border-radius: ", ";\n  color: ", ";\n  font-family: ", ";\n  font-size: 18px;\n  &::placeholder {\n    color: ", ";\n  }\n\n  &:disabled {\n    border: 1px solid ", ";\n    color: ", ";\n    background-color: ", ";\n  }\n"])), function (props) {
...
var MagicLinkEmailForm = function MagicLinkEmailForm() {
  ...
  var _extractErrorMessage$18 = extractErrorMessage.h(''),
    ...
    email = _extractErrorMessage$19[0],
    setEmail = _extractErrorMessage$19[1];
...
var BackButton = extractErrorMessage.He.button(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["\n  all: unset;\n  cursor: pointer;\n"])));
...
var GetHelpText = extractErrorMessage.He(Text)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  font-weight: bold !important;\n  cursor: pointer;\n"])));
...
var PasswordsEmailForm = function PasswordsEmailForm() {
  ...
  var _extractErrorMessage$24 = extractErrorMessage.h(!email),
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 8:
            setErrorMessage('');
            setIsSubmitting(true);
            internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref49) {
...
extractErrorMessage.He.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  height: ", ";\n  display: ", ";\n  transition: all 0.5s ease-out;\n  justify-content: center;\n  align-items: center;\n"])), function (props) {
...
var OAuthButtons = function OAuthButtons() {
  ...
  if (!config.oauthOptions) return /*#__PURE__*/extractErrorMessage.y(extractErrorMessage.g, null);
...
var MainScreen = function MainScreen() {
  ...
  }), displayHeader && title ? ( /*#__PURE__*/extractErrorMessage.wn.createElement(Flex, {
    justifyContent: "center"
  }, /*#__PURE__*/extractErrorMessage.wn.createElement(Header, {
    size: "header"
  }, title))) : ( /*#__PURE__*/extractErrorMessage.wn.createElement(extractErrorMessage.wn.Fragment, null)), /*#__PURE__*/extractErrorMessage.wn.createElement(ProductComponents, {
...
var useEmailDomain$1 = function useEmailDomain$1() {
  ...
  extractErrorMessage.p(function () {
    internal.readB2BInternals(stytch).bootstrap.getAsync().then(function (_ref56) {
...
var ArrowText = function ArrowText(_ref63) {
  ...
  if (type === 'eligible_to_join_by_email_domain' || type === 'pending_member') return /*#__PURE__*/extractErrorMessage.y(Text, null, "Join");
...
var Form = extractErrorMessage.He.form(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["\n  width: 100%;\n"])));
var PasswordResetForm = function PasswordResetForm() {
  ...
  var _extractErrorMessage$35 = extractErrorMessage.h(''),
    ...
    resetToken = _extractErrorMessage$36[0],
    setResetToken = _extractErrorMessage$36[1];
  ...
  var _extractErrorMessage$37 = extractErrorMessage.h(''),
    ...
    password = _extractErrorMessage$38[0],
    setPassword = _extractErrorMessage$38[1];
  var _extractErrorMessage$39 = extractErrorMessage.h(''),
    _extractErrorMessage$40 = _slicedToArray(_extractErrorMessage$39, 2),
    errorMessage = _extractErrorMessage$40[0],
    setErrorMessage = _extractErrorMessage$40[1];
  var _extractErrorMessage$41 = extractErrorMessage.h(0),
    _extractErrorMessage$42 = _slicedToArray(_extractErrorMessage$41, 2),
    passwordScore = _extractErrorMessage$42[0],
    setPasswordScore = _extractErrorMessage$42[1];
  var _extractErrorMessage$43 = extractErrorMessage.h(''),
    _extractErrorMessage$44 = _slicedToArray(_extractErrorMessage$43, 2),
    passwordFeedback = _extractErrorMessage$44[0],
    setPasswordFeedback = _extractErrorMessage$44[1];
  var _extractErrorMessage$45 = extractErrorMessage.h(true),
    _extractErrorMessage$46 = _slicedToArray(_extractErrorMessage$45, 2),
    invalidPassword = _extractErrorMessage$46[0],
    setInvalidPassword = _extractErrorMessage$46[1];
  var _extractErrorMessage$47 = extractErrorMessage.h(false),
    _extractErrorMessage$48 = _slicedToArray(_extractErrorMessage$47, 2),
    isSubmitting = _extractErrorMessage$48[0],
    setIsSubmitting = _extractErrorMessage$48[1];
  var _extractErrorMessage$49 = extractErrorMessage.h('none'),
    _extractErrorMessage$50 = _slicedToArray(_extractErrorMessage$49, 2),
    strengthPolicy = _extractErrorMessage$50[0],
    setStrengthPolicy = _extractErrorMessage$50[1];
  var _extractErrorMessage$51 = extractErrorMessage.h(0),
    _extractErrorMessage$52 = _slicedToArray(_extractErrorMessage$51, 2),
    missingCharacters = _extractErrorMessage$52[0],
    setMissingCharacters = _extractErrorMessage$52[1];
  var _extractErrorMessage$53 = extractErrorMessage.h(0),
    _extractErrorMessage$54 = _slicedToArray(_extractErrorMessage$53, 2),
    missingComplexity = _extractErrorMessage$54[0],
    setMissingComplexity = _extractErrorMessage$54[1];
  var _extractErrorMessage$55 = extractErrorMessage.h(false),
    _extractErrorMessage$56 = _slicedToArray(_extractErrorMessage$55, 2),
    isPasswordBreached = _extractErrorMessage$56[0],
    setIsPasswordBreached = _extractErrorMessage$56[1];
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 4:
            setErrorMessage('');
            setIsSubmitting(true);
            internal.readB2BInternals(stytch).searchManager.searchMember(email, organization.organization_id).then(function (_ref72) {
...
var InsetContainer = extractErrorMessage.He.div(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["\n  background-color: #f3f5f6;\n  color: #000;\n  font-size: 16px;\n  line-height: 28px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  gap: 8px;\n  padding: 16px 8px;\n"])));
var CodeList = extractErrorMessage.He.ul(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["\n  list-style: none;\n  padding: 0;\n  margin: 0;\n"])));
...
var Select = extractErrorMessage.He.select(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: ", ";\n  height: 47px;\n  box-sizing: border-box;\n  padding: 0 8px;\n  color: ", ";\n  font-family: ", ";\n  width: 80px;\n  font-size: 18px;\n"])), function (props) {
  return props.theme.inputs.backgroundColor;
}, function (props) {
  return props.theme.inputs.borderColor;
}, function (props) {
...
var CountrySelector = function CountrySelector(_ref74) {
  ...
  }, Object.entries(internal.COUNTRIES_LIST).map(function (_ref75) {
...
var SMSOTPEnrollScreen = function SMSOTPEnrollScreen() {
  ...
  var _extractErrorMessage$59 = extractErrorMessage.wn.useState((_a = enrolledNumber === null || enrolledNumber === void 0 ? void 0 : enrolledNumber.countryCode) !== null && _a !== void 0 ? _a : DEFAULT_COUNTRY_CODE),
  ...
  var _extractErrorMessage$61 = extractErrorMessage.wn.useState((_b = enrolledNumber === null || enrolledNumber === void 0 ? void 0 : enrolledNumber.phoneNumber) !== null && _b !== void 0 ? _b : ''),
    ...
    phoneNumber = _extractErrorMessage$62[0],
    setPhoneNumber = _extractErrorMessage$62[1];
...
var OTPControl = function OTPControl(_ref91) {
  ...
  var _extractErrorMessage$63 = extractErrorMessage.h(''),
    ...
    setOtp = _extractErrorMessage$64[1];
...
var ExpirationMessage = function ExpirationMessage(_ref93) {
  ...
  var _extractErrorMessage$65 = extractErrorMessage.h(function () {
    ...
    seconds = _extractErrorMessage$66[0],
    setSeconds = _extractErrorMessage$66[1];
...
var CopyButton = extractErrorMessage.He.button(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["\n  all: unset;\n  flex: 0 0 24px;\n  height: 28px;\n  opacity: 0;\n  :focus {\n    opacity: 1;\n  }\n"])));
var CodeContainer = extractErrorMessage.He(InsetContainer)(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["\n  cursor: pointer;\n  :hover ", " {\n    opacity: 1;\n  }\n"])), CopyButton);
...
var Image = extractErrorMessage.He.img(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["\n  width: 150px;\n"])));
...
var AppContainer$1 = function AppContainer$1() {
  ...
  var _extractErrorMessage$67 = extractErrorMessage.Ze(),
    displayWatermark = _extractErrorMessage$67.displayWatermark;
  var isOnlyFloatingOneTap = useIsOnlyFloatingOneTap();
...
var AppContainer = function AppContainer(_ref119) {
  ...
  var _extractErrorMessage$68 = extractErrorMessage.h(function () {
    ...
    displayWatermark = _extractErrorMessage$69[0],
    setDisplayWatermark = _extractErrorMessage$69[1];
  extractErrorMessage.p(function () {
    ...
    internal.readB2BInternals(client).bootstrap.getAsync().then(function (_ref120) {
